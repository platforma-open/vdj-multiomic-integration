...
export type VdjMultiomicIntegrationBlockContract = BlockContract;
export type VdjMultiomicIntegrationBlockOutputs  = BlockOutputs;
export type VdjMultiomicIntegrationBlockData     = BlockData;
export const VdjMultiomicIntegrationBlockPointer = BlockPointer;
